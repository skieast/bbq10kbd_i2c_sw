...
#ifndef _SAMHA1_TCC_COMPONENT_
#define _SAMHA1_TCC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR TCC */
/* ========================================================================== */
/** \addtogroup SAMHA1_TCC Timer Counter Control */
/*@{*/
...
#define TCC_STATUS_MASK             _U_(0x0F0FFFFF) /**< \brief (TCC_STATUS) MASK Register */
...
#define   TCC_WAVEB_RAMPB_RAMP2C_Val      _U_(0x3)   /**< \brief (TCC_WAVEB) Critical RAMP2 operation */
