 ...
 * \file
 *
 * \brief Header file for SAMHA1E15AB
 *
...
#ifndef _SAMHA1E15AB_
#define _SAMHA1E15AB_

/**
 * \ingroup SAMHA1_definitions
 * \addtogroup SAMHA1E15AB_definitions SAMHA1E15AB definitions
 * This file defines all structures and symbols for SAMHA1E15AB:
...
/* ************************************************************************** */
/**  CMSIS DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  /******  SAMHA1E15AB-specific Interrupt Numbers ***********************/
  PM_IRQn                  =  0, /**<  0 SAMHA1E15AB Power Manager (PM) */
  SYSCTRL_IRQn             =  1, /**<  1 SAMHA1E15AB System Control (SYSCTRL) */
  WDT_IRQn                 =  2, /**<  2 SAMHA1E15AB Watchdog Timer (WDT) */
  RTC_IRQn                 =  3, /**<  3 SAMHA1E15AB Real-Time Counter (RTC) */
  EIC_IRQn                 =  4, /**<  4 SAMHA1E15AB External Interrupt Controller (EIC) */
  NVMCTRL_IRQn             =  5, /**<  5 SAMHA1E15AB Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  6, /**<  6 SAMHA1E15AB Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMHA1E15AB Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMHA1E15AB Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn             = 10, /**< 10 SAMHA1E15AB Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn             = 11, /**< 11 SAMHA1E15AB Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMHA1E15AB Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMHA1E15AB Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMHA1E15AB Serial Communication Interface 5 (SERCOM5) */
  TCC0_IRQn                = 15, /**< 15 SAMHA1E15AB Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 16, /**< 16 SAMHA1E15AB Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 17, /**< 17 SAMHA1E15AB Timer Counter Control 2 (TCC2) */
  TC3_IRQn                 = 18, /**< 18 SAMHA1E15AB Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 19, /**< 19 SAMHA1E15AB Basic Timer Counter 4 (TC4) */
  TC5_IRQn                 = 20, /**< 20 SAMHA1E15AB Basic Timer Counter 5 (TC5) */
  TC6_IRQn                 = 21, /**< 21 SAMHA1E15AB Basic Timer Counter 6 (TC6) */
  TC7_IRQn                 = 22, /**< 22 SAMHA1E15AB Basic Timer Counter 7 (TC7) */
  ADC_IRQn                 = 23, /**< 23 SAMHA1E15AB Analog Digital Converter (ADC) */
  AC_IRQn                  = 24, /**< 24 SAMHA1E15AB Analog Comparators  (AC) */
  DAC_IRQn                 = 25, /**< 25 SAMHA1E15AB Digital Analog Converter (DAC) */
  PTC_IRQn                 = 26, /**< 26 SAMHA1E15AB Peripheral Touch Controller (PTC) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PERIPHERAL ID DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  BASE ADDRESS DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
/** \defgroup SAMHA1E15AB_port PORT Definitions */
/*@{*/

#include "pio/samha1e15ab.h"
/*@}*/

/* ************************************************************************** */
/**  MEMORY MAPPING DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
...
#define DSU_DID_RESETVALUE    _UL_(0x10011584)
...
/* ************************************************************************** */
/**  ELECTRICAL DEFINITIONS FOR SAMHA1E15AB */
/* ************************************************************************** */
